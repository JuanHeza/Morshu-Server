...
type Product struct {
	...
	DataType          dt.DataType        `bson:"data_type,omitempty"`
...
func main_restriction() dt.Criteria {
	return dt.Criteria{Field: "data_type", Restriction: "equal", Value: dt.Producto_type}
}
...
func ReadCriteria(r *http.Request, criteria []dt.Criteria) (list []Product) {
	coll := database.GetCollection(r)
	criteria = append(criteria, main_restriction())
